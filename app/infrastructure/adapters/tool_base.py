"""
TOOL BASE — Clase base abstracta de herramientas de Alfonso.

¿QUÉ HACE?
Define el contrato y estructura formal para todas las herramientas del sistema que el LLM puede descubrir y ejecutar.

¿CUÁNDO LO HACE?
Al registrar una nueva herramienta para asegurar que cuenta con descripción, parámetros y validaciones de tipos.

¿CÓMO LO HACE?
Utilizando tipado de Python y metadatos de funciones para extraer un esquema JSON representativo.

¿CON QUÉ OTROS SCRIPTS ESTÁ RELACIONADO?
- app.infrastructure.adapters.tool_registry.py (mantiene y valida la lista de herramientas registradas)
