# Especificación: 003-fake-providers
...
Aislamiento y/o eliminación de implementaciones de proveedores que devuelven datos falsos estáticos (GenericApiProvider, Plaid, Tink, Qonto).
