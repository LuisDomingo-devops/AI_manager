# Especificación: 004-accounting-integrity
...
Garantizar la integridad contable (partida doble, isolation por tenant, validaciones robustas sin except Exception).
